...
if(!empty($_GET['p']) and $_GET['p']=='cari_kep'){
	$tahun = $_POST['tahun'];
	$idkab = $_POST['idkab'];
...
<div class="full_w">
<div class="header_01">
	<div align="justify">SEKTOR KEPENDUDUKAN</div>
</div>
...
?>
					<tbody>
						<tr>
							...
							<td align="center">
							<a href="?p=peta&x=<?php echo $data['x']."&y=".$data['y'];?>">Peta</a>
							</td>
...
?>
				...
				<div class="entry">
					<div class="pagination">
						<a href="?p=cari_kep">Prev</a>
						<?php
					#show pagination number
					foreach($pg['pages'] as $key=>$value){
				?>
        			<a href="?p=cari_kep" class="page"><?php echo $value;?></a>
       			<?php
					}
				?>
					<a href="?p=cari_kep"	class="page">Next</a>
					</div>
					<div class="sep"></div>		
